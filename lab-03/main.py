...
class MainMenu:
    ...
    def setup_ui(self):
        ...
        task1_btn = ttk.Button(button_frame, text="Заливка", 
            command=self.open_task1, width=30)
        task1_btn.pack(pady=10)
        
        task2_btn = ttk.Button(button_frame, text="Рисование отрезка", 
            command=self.open_task2, width=30)
        task2_btn.pack(pady=10)
        
        task3_btn = ttk.Button(button_frame, text="Градиентное окрашивание", 
    ...
    def open_task1(self):
        self.open_task_window("Заливка", task1.ColorFiller)
    
    def open_task2(self):
        self.open_task_window("Рисование отрезка", task2.LinePainter)
    
    def open_task3(self):
        self.open_task_window("Градиентное окрашивание", task3.FadeFiller)
